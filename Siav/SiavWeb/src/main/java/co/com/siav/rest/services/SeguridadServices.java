...
public class SeguridadServices {
	...
	@GET
	@Path("usuario/consultar/{perfil}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<UsuarioSistemaResponse> getUsuariosPorPerfil(@PathParam("perfil") Long perfil){
		return bean.consultarUsuariosPorPerfil(perfil);
	}
