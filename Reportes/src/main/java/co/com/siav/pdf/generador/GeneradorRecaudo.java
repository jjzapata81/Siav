...
public class GeneradorRecaudo extends GeneradorPDFBase{
	
	private static final String ARCHIVO_JRXML="recaudo.jrxml";
	
	private List<RecaudoPDF> data;

	public GeneradorRecaudo(List<RecaudoPDF> data) {
		this.data = data;
	}
