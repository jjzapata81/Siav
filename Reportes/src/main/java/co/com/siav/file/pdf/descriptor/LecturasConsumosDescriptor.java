...
public enum LecturasConsumosDescriptor implements IPdfDescriptor{
	...
	private LecturasConsumosDescriptor(String header, String attribute, float columnWidth, DataType type, Alignment alignment){
		this.header = header;
