...
public class Constantes {
	...
	public static final String ERR_DETALLE_FACTURA = "Error obteniendo el detalle de factura: ";
	public static final String ERR_HISTORICO_CONSUMOS = "Error obteniendo el histórico de consumos para la instalación ";
