...
public class QueryHelper {
	...
	public static String getConsolidadoConcepto(Filter filter){
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT 10 AS orden, ciclo, fd.cdconcepto AS codigo, fd.nombreconcepto, SUM(fd.valor) AS valor, SUM(fd.saldo) AS cartera, SUM(fd.valor+fd.saldo) AS total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idcargofijo ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 20, ciclo, fd.cdconcepto, fd.nombreconcepto, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_excesos e, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = e.codigo ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 10, ciclo, fd.cdconcepto, fd.nombreconcepto, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idexceso ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 30, ciclo, fd.cdconcepto, t.descripcion, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd, ta_tarifas t ");
		sb.append(" WHERE fd.cdconcepto = s.idrecargo ");
		sb.append("   AND fd.cdconcepto = t.cdconcepto ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, t.descripcion ");
		sb.append("UNION ");
		sb.append("SELECT 40, ciclo, fd.cdconcepto, fd.nombreconcepto, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idinteres ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 50, ciclo, fd.cdconcepto, fd.nombreconcepto || ' (CARTERA)', SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idderecho ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 60, ciclo, fd.cdconcepto, fd.nombreconcepto || ' (CARTERA)', SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idmoroso ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 100, ciclo, fd.cdconcepto, fd.nombreconcepto, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto = s.idsaldoafavor ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ");
		sb.append("UNION ");
		sb.append("SELECT 70, ciclo, fd.cdconcepto, fd.nombreconcepto, SUM(fd.valor) valor, SUM(fd.saldo) cartera, SUM(fd.valor+fd.saldo) total ");
		sb.append("  FROM ta_sistema s, ta_factura_detalle fd ");
		sb.append(" WHERE fd.cdconcepto NOT IN (s.idcargofijo, s.idexceso, s.idbasico, s.idcomplementario, s.idsuntuario, s.idderecho, s.idrecargo, s.idinteres, s.idderecho, s.idmoroso, s.idsaldoafavor) ");
		sb.append("   AND fd.ciclo = ");
		sb.append(filter.getCiclo());
		sb.append(" GROUP BY ciclo, fd.cdconcepto, fd.nombreconcepto ORDER BY 1 ");
		return sb.toString();
	}
