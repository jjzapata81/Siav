...
INSERT INTO ta_formato_recaudo(idformato, fecha, valor, referencia, formato_fecha, separador, separador_aux, posicion_aux, posicion_inicial_fra, posicion_final_fra)
    VALUES ('1', 0, 5, 8, 'dd-MM-yyyy', ',', '-', 0, 4, 10);
